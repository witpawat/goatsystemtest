...
<form action="{{ route('admin.updateGene') }}" method="POST" enctype="multipart/form-data">
    @csrf
     ...
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group ">
                    <strong>พันธุ์แพะ :</strong>
                    <input type="text" name="gene_name" class="form-control" placeholder="Gene Name">
                        @error('gene_name')
