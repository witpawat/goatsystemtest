...
<form action="{{ route('admin.updateVaccine') }}" method="POST" enctype="multipart/form-data">
    @csrf
     ...
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group ">
                    <strong>วัคซีนแพะ :</strong>
                    <input type="text" name="vaccine_name" class="form-control" placeholder="Vaccine Name">
                        @error('vaccine_name')
