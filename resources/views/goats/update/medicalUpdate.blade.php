...
<form action="{{ route('goats.medicalUpdate', $goat->goatId) }}" method="POST" enctype="multipart/form-data">
    @csrf
     ...
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="date" name="dateExamination" class="form-control" required oninvalid="this.setCustomValidity('กรุณากรอกข้อมูล')" oninput="this.setCustomValidity('')">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
               ...
               <br> <select id="typeOfDisease" name="typeOfDisease" class="form-control" required oninvalid="this.setCustomValidity('กรุณากรอกข้อมูล')" oninput="this.setCustomValidity('')">
                ...
                <div class="form-group">
                    ...
                    <br>
                        <div class="form-check form-check-inline">
                            <input type="radio" class="form-check-input" id="pass" name="result" value="ผ่าน">
                            <label for="pass" class="form-check-label">ผ่าน</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input type="radio" class="form-check-input" id="not pass" name="result" value="ไม่ผ่าน">
                            <label for="not pass" class="form-check-label">ไม่ผ่าน</label>
                        </div>
                    @error('result')
                     <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                    @enderror
